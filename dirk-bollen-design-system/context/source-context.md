...
Canonical design-system title: Personal brand system for Design System
...
- /Users/dirkbollen/claudeai/claude/Dirk Bollen design system
...
1. For each linked folder, run the bounded local intake command before writing design-system files:
   - `"$OD_NODE_BIN" "$OD_BIN" tools connectors local-design-context --path '/Users/dirkbollen/claudeai/claude/Dirk Bollen design system' --output context/local-code/Dirk-Bollen-design-system.md`
